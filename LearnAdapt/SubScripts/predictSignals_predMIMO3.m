function [PredData, varargout] = predictSignals_predMIMO3(varargin)
...
%     [PredictedData,spikeDataNew,Hnew] = predAdaptEMGs(BinnedData,usableSpikeData,filter.H,Adapt);
  ...
  %  [PredictedData,spikeDataNew,ActualDataNew]=predMIMO4(Inputs,filter.H,numsides,fs,ActualData); % commented by sn 102716
