function DidHeGetInTheTarget(binnedData)
% This script looks to see if the monkey held in the target for the
% appropriate reach time. This is to fix the broken trial table, which is
% missing the Go Cue as well as the outcome of the trial
