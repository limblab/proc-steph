function [TrajectoriesX, TrajectoriesY, TargetNumber] = TrajectoriesStarting200AfterGo(binnedData,EpochLength)
...
EpochNumBins = int8((EpochLength-0.2)/0.05); % Number of values/epoch
...
for a=1:length(tt)
    ...
    EpochEnd = GoCue+EpochLength-0.2;
