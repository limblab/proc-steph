function [EMGpreds, CursorPreds, recordedEMG, recordedPos] = ApplyCascadeDecoders(binnedData,N2E,E2F)

% Apply N2E to get EMG predictions
[Pred_EMG_struct] = predictSignals(N2E, binnedData);
EMGpreds=Pred_EMG_struct.preddatabin;

% Calculate how many taps
NumberOfTaps=N2E.fillen/N2E.binsize;
...
% added 5/15 for padding to make the computed curosorpreds and the original
% cursorpreds line up
CursorPreds=cat(1,nan(15,2),CursorPreds);
