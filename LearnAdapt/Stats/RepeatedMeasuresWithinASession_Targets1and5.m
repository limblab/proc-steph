function pval=RepeatedMeasuresWithinASession_Targets1and5(MetricCell,Day)
...
% Make a table
t = table(Labels,AllData(:,1), AllData(:,5),...
    'VariableNames',{'Epoch','target1','target5'});
...
rm = fitrm(t,'target1-target5~Epoch','WithinDesign',Meas); 
