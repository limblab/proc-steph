...
subplot(2,1,1)
hold on
errorbar([.85:4.85],IMonIM_mean, IMonIMste, -IMonIMste,'k.','LineWidth',1.2) 
errorbar([1.15:5.15],IMonIP_mean, IMonIPste, -IMonIPste,'k.','LineWidth',1.2)
...
subplot(2,1,2)
hold on;
errorbar([.85:4.85],MMonMM_mean, MMonMMste, -MMonMMste,'k.','LineWidth',1.2) 
errorbar([1.15:5.15],MMonMP_mean, MMonMPste, -MMonMPste,'k.','LineWidth',1.2)
