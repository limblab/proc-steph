function PlotAllIsometricAcrossPredictionssingleEMG(IsoBinned,IonIact,IonIpred,WonIpred,SonIpred,HonIpred,emgInd,save,foldername, filename)
...
legend('Actual',strcat('Within | vaf=',num2str(muscleVAF.IonI)),strcat('Hybrid | vaf=',num2str(muscleVAF.HonI)),strcat('Move | vaf=',num2str(muscleVAF.WonI)),strcat('Spring | vaf=',num2str(muscleVAF.SonI)))
MillerFigure
