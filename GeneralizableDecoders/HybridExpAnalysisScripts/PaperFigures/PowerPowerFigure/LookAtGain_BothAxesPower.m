...
IsoEMGPSDall=[]; WmEMGPSDsall=[]; SprEMGPSDsall=[];
IsoEMGPSDall = pwelch(IsoTest.emgdatabin(:,a),100,0,Fs);
...
IsoEMGPSDs(a)=IsoEMGPSDall(40);
WmEMGPSDs(a)=WmEMGPSDsall(40);
SprEMGPSDs(a)=SprEMGPSDsall(40);
