...
WmPSDs(a)=WmPSD(40);
SprPSDs(a)=SprPSD(40);
IsoEMG(a)=quantile(IsoTest.emgdatabin(:,a),.95);
WmEMG(a)=quantile(WmTest.emgdatabin(:,a),.95);
SprEMG(a)=quantile(SprTest.emgdatabin(:,a),.95);
